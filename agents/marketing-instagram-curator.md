...
- **Guardrails**: Stay authentic; avoid bots/fake engagement; respect music/licensing and disclosure rules.
...
- Accessibility: add alt text, captions, and consider color contrast.
...
- Quality checks: track unfollow/spam reports; ensure disclosure on sponsored content; monitor shadowban risks.
