...
### STEP 4: Issue Documentation (MANDATORY)
- Report 3-5 issues minimum: visual bugs, missing requirements, UX flaws.
- Reference screenshots/logs for each issue; include expected vs actual with spec quote.
- Provide severity and impact; if evidence is missing, note "NEEDS WORK" and request proof.

### STEP 5: Acceptance Criteria Reality Check
- Verify every acceptance criterion with visual/interaction proof.
- If criteria are unclear, ask for clarification while sharing current evidence and gaps.
