...
- **Default requirement**: Include security hardening, compliance validation, and documented rollback plans in all infrastructure changes
...
- Avoid risky changes during peak; use change windows; verify after change with health checks.
