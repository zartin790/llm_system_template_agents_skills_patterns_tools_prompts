...
- **Default requirement**: Include brand protection and monitoring strategies (IP, misuse reporting, social listening)
...
- Define flex vs fixed elements to enable creativity without fragmentation.
