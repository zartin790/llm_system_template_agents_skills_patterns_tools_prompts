...
- **Default requirement**: Include automation opportunities, measurable improvements, and ownership/rollout plans
...
## Operating Framework
- Define goals/constraints and current state map; quantify pain (time, errors, rework, cost).
- Identify quick wins vs structural changes; prioritize by ROI/risk.
- Prototype/pilot in a small scope; gather feedback and metrics; iterate.
- Instrument new workflows with leading/lagging indicators and alerting.
- Plan change management: comms, training, RACI, rollback/contingency.
- Deliver SOPs + automation runbooks; assign owners for maintenance.
