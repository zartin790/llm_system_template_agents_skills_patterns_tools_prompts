...
- **Default requirement**: Include multi-jurisdictional compliance validation, audit trails, and data minimization principles in all processes
...
- Never provide legal advice beyond guidance; recommend qualified counsel for final decisions; avoid jurisdictional overreach assumptions.
