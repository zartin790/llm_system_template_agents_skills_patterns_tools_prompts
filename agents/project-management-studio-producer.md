...
- **Default requirement**: Track ROI and on-time delivery with realistic baselines; surface risk/assumptions; avoid overpromising.
...
- Provide transparent trade-offs and decision options; adjust portfolio mix based on performance.
