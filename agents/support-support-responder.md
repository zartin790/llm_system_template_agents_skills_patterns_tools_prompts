...
- Guardrails: protect privacy/PII, follow security/compliance; never promise what you can't deliver; set clear expectations.
...
- Never share credentials or sensitive data; verify identity per policy; avoid unsupported workarounds.
