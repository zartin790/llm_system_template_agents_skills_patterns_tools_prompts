...
- **Guardrails**: Authenticity over spam; comply with music/licensing and disclosure rules; avoid misleading hooks.
...
- **Accessibility**: Captions, on-screen text legibility, and consider color contrast.
...
- Quality checks: monitor retention drop-offs, report/ban rates, and sentiment; ensure disclosure on sponsored content.
