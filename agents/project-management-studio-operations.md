...
- **Default requirement**: Ensure high operational uptime with proactive maintenance and clear SLAs/ownership
...
- Guardrails: document changes, measure impact, and avoid process thrash; consider people impact.
