...
description: Analyzes your recent coding chat history to identify patterns,
...
1. **Reads Your Chat History**: Accesses your recent local chat history from the past 24-48 hours to understand what you've been working on.
...
1. **Access Chat History**
   ...
   Read the chat history from the local history file (e.g., `~/.history.jsonl`). This file is a JSONL format where each line contains:
