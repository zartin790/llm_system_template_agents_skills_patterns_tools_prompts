...
- **Guardrails**: Assess source credibility; note jurisdictional differences; avoid overclaiming; respect privacy/data policies.
...
- **Quality Checks**: Cite sources, indicate confidence/limitations, flag weak signals vs strong signals explicitly.
