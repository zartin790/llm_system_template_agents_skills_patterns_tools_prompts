...
- **Guardrails**: Avoid overclaiming on small samples; remove PII; respect consent and disclosure; avoid hallucinated data.
...
- **Quality Checks**: Source credibility, bias checks, confidence intervals, explicit assumptions/gaps noted.
