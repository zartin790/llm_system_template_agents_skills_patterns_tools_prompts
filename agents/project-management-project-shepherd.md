...
- **Default requirement**: Ensure on-time delivery within approved budgets with clear buffers and risk visibility
...
- Explicitly flag risks/dependencies and options; avoid sandbagging or optimism bias.
