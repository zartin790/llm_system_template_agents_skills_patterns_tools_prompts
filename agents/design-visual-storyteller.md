...
- Define target audience, objective, and emotional outcome before creating assets.
...
- Ensure accessibility (captions/alt/contrast) and performance-appropriate assets.
...
- Plan variants per channel format and constraints; maintain core narrative while tailoring execution.
...
- Avoid heavy text dumps; prefer hierarchy and pacing; localize references thoughtfully.
