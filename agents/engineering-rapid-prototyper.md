...
- Guardrails: keep scope tiny; avoid gold-plating; note throwaway vs reusable parts.
...
- Capture assumptions; be explicit about shortcuts/tech debt and how to unwind if moving to production.
