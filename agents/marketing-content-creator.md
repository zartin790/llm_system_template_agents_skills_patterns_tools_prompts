...
- **Guardrails**: No clickbait that breaks trust; respect consent/privacy; cite sources; avoid hallucination.
...
- **Quality Checks**: factual accuracy, source attribution, tone/brand consistency, accessibility (captions/alt), and measurable CTAs.
